...
const CreatePostOverlay = ({ originalUrl, handleCreatePostOverlayClose }) => {
  ...
  return (
    <div className={`create-post-overlay`} onClick={handleCreatePostOverlayClose}>
      <div className={`create-post-content`} onClick={(e) => e.stopPropagation()}>
        {originalUrl &&
          <button className="createPost-close-button" onClick={handleCreatePostOverlayClose}>
        ...
        <form>
          ...
          <div className="create-post-buttons">
            ...
            {originalUrl &&
              <button type="button" onClick={handleCreatePostOverlayClose}>Cancel</button>
            }
          </div>
        </form>
