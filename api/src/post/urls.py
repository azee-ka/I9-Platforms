...
from .views import create_post, get_post_by_id, create_comment, create_like, create_dislike, delete_post, get_like_status
...
urlpatterns = [
    ...
    path('posts/<uuid:post_id>/like-status/', get_like_status, name='get_like_status'),
